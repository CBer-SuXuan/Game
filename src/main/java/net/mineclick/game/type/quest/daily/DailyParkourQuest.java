...
public class DailyParkourQuest extends DailyQuest {
    @Getter
    public List<QuestObjective> objectives = List.of(
            new QuestObjective() {
                ...
                public String getName(GamePlayer player) {
                    ...
                    return "Complete " + count + " parkour course" + (count == 1 ? "" : "s");
                }
            }
    );
    @Getter
    public List<Stage> stages = List.of(
            ...
            new Stage(2, 7, 20, 40),
            new Stage(3, 9, 30, 60),
            new Stage(4, 11, 40, 80),
            new Stage(5, 13, 60, 100)
    );
